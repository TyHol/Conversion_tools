    ...
    // ── 3. Degree-based formats: DMS / DDM / decimal / projected ─────────
        ...
        if (commaIdx > 0) {
            ...
            if (a !== null && b !== null) {
                ...
                showFormatDialog(`${a}, ${b}`, a, b, defIdx);
                return true;
            }
        }
...
Dialog {
    ...
    onAccepted: {
        ...
        if (idx === 0) {          // WGS84 lat, lon
            ...
            disp = parsedA + ", " + parsedB + " (EPSG:" + epsg + ")"
    ...
    ColumnLayout {
        ...
        ComboBox {
            ...
            Layout.fillWidth: true
            model: [
                qsTr("WGS84 decimal  —  lat, lon  (first value is latitude)"),
                qsTr("WGS84 decimal  —  lon, lat  (first value is longitude)"),
...
//end of second custom box
 ...
 onTextChanged: crs2ChangeTimer.restart()
  }
