...
//changable stuff 
property var filetimedate : "26.3.26..1" // version date
...
function populatePointLayerPicker() {
    ...
    // Always include "Active Layer" option
...
MenuItem {
    id: navButton
    text: qsTr("External link of touch point")
...
Button {
 ...
 updateCoordinates(pos.x, pos.y, canvasEPSG, custom1CRS.text, custom2CRS.text) 
     ...
     Row {
        spacing: 0
        Label { text: "Settings:"; font.pixelSize: 9; font.family: "Arial"; font.italic: true; anchors.verticalCenter: parent.verticalCenter; leftPadding: 0; rightPadding: 0 }
        CheckBox {
            id: showCustomisation
            checked: false
            onCheckedChanged: customisation.visible = checked
        }
    }
}
Button {
...
Layout.fillWidth: true
visible: false
onVisibleChanged: if (visible) populatePointLayerPicker()
...
GridLayout {  // grid 2
    ...
    Button {
        ...
        onClicked: {
            ...
            showCustom1.checked = custom1vis; showDegrees.checked  = wgs84vis
    ...
    // row 4 — external map picker label
    Label { text: "External map:"; font.pixelSize: 10; font.family: "Arial"; font.italic: true; Layout.columnSpan: 3 }

    // row 5 — map picker (2×2 nested grid, spans all 3 columns)
    ...
    // row 6 — point layer picker
    Label { text: "Add points to:"; font.pixelSize: 10; font.family: "Arial"; font.italic: true; Layout.columnSpan: 3 }
    ComboBox {
        id: pointLayerCombo
        Layout.columnSpan: 3
        Layout.fillWidth: true
